        ...
        <div class="col-12">
          ...
          <div class="card">
			...
			<div class="card-header">
              <a class="btn btn-success btn-sm float-right" href="<?php echo base_url()?>users/tambahusers"><i class="fas fa-plus">&nbsp;</i><?php echo lang('add');?></a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<th><?php echo lang('super_admin');?> </th>
                ...
                <tr>
					...
					<td class="a-center"><?php if($dfu["roles"]=="1"){ echo lang('yes'); }else{ echo lang('no'); }?></td>
					<td class="a-center"><?php if($dfu["active"]=="1"){ echo lang('active'); }else{ echo lang('no'); }?></td>
                  <td><a class="btn btn-info btn-sm" href="<?php echo base_url()?>users/editusers/<?php echo $dfu["iduser"];?>"><i class="fas fa-pencil-alt">&nbsp;</i><?php echo lang('edit');?></a>&nbsp; | &nbsp;<a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-default-<?php echo $i;?>"><i class="fas fa-trash">&nbsp;</i><?php echo lang('delete');?></a></td>
                </tr>
