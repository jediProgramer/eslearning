        ...
        <div class="col-12">
          ...
          <div class="card">
			...
			<div class="card-header">
              <a class="btn btn-success btn-sm float-right" href="<?php echo base_url()?>courses/tambahinstructors/<?php echo $idcourses;?>"><i class="fas fa-plus">&nbsp;</i><?php echo lang('add');?></a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <th><?php echo lang('instructors');?></th>
				...
				<?php
					...
					$queryinstructors = $this->db->query("SELECT fullname FROM `".$this->db->dbprefix('users')."` WHERE iduser ='".$d["iduser"]."'");
					$rowi = $queryinstructors->row();
					$instructors=$rowi->fullname;
				?>	
                <tr>
				  <td><?php echo $i;?></td>
				  <td><?php echo $courses;?></td>
				  <td><?php echo $instructors;?></td>
                  <td><a class="btn btn-info btn-sm" href="<?php echo base_url()?>courses/editinstructors/<?php echo $d["idcourses"];?>/<?php echo $d["idinstructors"];?>"><i class="fas fa-pencil-alt">&nbsp;</i><?php echo lang('edit');?></a>&nbsp; | &nbsp;<a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-default-<?php echo $i;?>"><i class="fas fa-trash">&nbsp;</i><?php echo lang('delete');?></a></td>
                </tr>
						...
						<div class="modal-dialog">
						  <div class="modal-content">
							...
							<div class="modal-body">
							  <p><?php echo lang('delete_message');?> <br/><br/><?php echo $instructors;?>&hellip;</p>
							<form action="<?php echo base_url()?>courses/deletesinstructors" method="post" enctype="multipart/form-data">
							<input type="hidden" id="idinstructors" name="idinstructors" value="<?php echo $d["idinstructors"];?>">
