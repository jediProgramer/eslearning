...
<div class="content-header">
  <div class="container-fluid">
	<div class="row mb-2">
	  <div class="col-sm-6">
		<h1 class="m-0 text-dark">Edit Pengabdian Dosen</h1>
	</div><!-- /.col -->
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  ...
		  <li class="breadcrumb-item active">Edit Pengabdian Dosen</li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary card-outline">
          <div class="card-body">
            	<?php
					...
					{
			    ?>
               <form class="form-horizontal" action="<?php echo base_url()?>lecturer/updatededication" method="post" enctype="multipart/form-data" id="webdedicationForm">
                <div class="card-body">
				  ...
				  <div class="form-group row">
                    <label for="inputSkema" class="col-sm-2 col-form-label">Skema</label>
						...
						<?php
							foreach($dataskemapengabdian as $ds)
							{
						?>
							<option value="<?php echo $ds["skemapengabdian"];?>" <?php if($ds["skemapengabdian"]==$d["skema"]){ echo "selected";} ?>><?php echo $ds["skemapengabdian"];?></option>
						<?php
							}
						?>  
                        </select>
				  ...
				  <div class="form-group row">
                    <label for="inputTahun" class="col-sm-2 col-form-label">Kota</label>
                    <div class="col-sm-10">
                ...
                <div class="card-footer">
				  ...
				  <input type="hidden" class="form-control" id="iddedication" name="iddedication" value="<?php echo $d["iddedication"];?>">
