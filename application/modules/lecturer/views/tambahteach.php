...
<div class="content-header">
  <div class="container-fluid">
	<div class="row mb-2">
	  <div class="col-sm-6">
		<h1 class="m-0 text-dark">Tambah Pengajaran Dosen</h1>
	</div><!-- /.col -->
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  ...
		  <li class="breadcrumb-item active">Tambah Pengajaran Dosen</li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          <div class="card-body">
               ...
               <form class="form-horizontal" action="<?php echo base_url()?>lecturer/saveteach" method="post" enctype="multipart/form-data" id="webteachForm">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputJenjang" class="col-sm-2 col-form-label">Semester</label>
						...
						<?php
							...
							{
						?>
							<option value="<?php echo $ds["semester"];?>"><?php echo $ds["semester"];?></option>
						<?php
							}
						?>  
                        </select>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="type" class="form-control" id="kode_mk" name="kode_mk">
                    </div>
                  </div>
				  <div class="form-group row">
                    <label for="inputWebsite" class="col-sm-2 col-form-label">Nama Matakuliah</label>
                    <div class="col-sm-10">
                      <input type="type" class="form-control" id="nama_mk" name="nama_mk">
                    </div>
                  </div>
				  <div class="form-group row">
                    <label for="inputWebsite" class="col-sm-2 col-form-label">Kode Kelas</label>
                    <div class="col-sm-10">
                      <input type="type" class="form-control" id="kode_kelas" name="kode_kelas">
                    </div>
                  </div>
