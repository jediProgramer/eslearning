...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo lang('subcategory');?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>admin"><?php echo lang('home');?></a></li>
              <li class="breadcrumb-item active"><?php echo lang('subcategory');?></li>
            </ol>
          </div>
        </div>
        ...
        <div class="col-12">
          ...
          <div class="card">
			...
			<div class="card-header">
              <a class="btn btn-success btn-sm float-right" href="<?php echo base_url()?>subcategory/tambah"><i class="fas fa-plus">&nbsp;</i><?php echo lang('add');?></a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a class="btn btn-info btn-sm" href="<?php echo base_url()?>subcategory/edit/<?php echo $d["idsubcategory"];?>"><i class="fas fa-pencil-alt">&nbsp;</i><?php echo lang('edit');?></a>&nbsp; | &nbsp;<a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-default-<?php echo $i;?>"><i class="fas fa-trash">&nbsp;</i><?php echo lang('delete');?></a></td>
                </tr>
				  ...
				  <div class="modal fade" id="modal-default-<?php echo $i;?>">
						<div class="modal-dialog">
						  <div class="modal-content">
							...
							<form action="<?php echo base_url()?>subcategory/deletes" method="post" enctype="multipart/form-data">
							  <input type="hidden" id="idsubcategory" name="idsubcategory" value="<?php echo $d["idsubcategory"];?>">
							</div>
