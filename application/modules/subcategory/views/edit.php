...
<div class="content-header">
  <div class="container-fluid">
	<div class="row mb-2">
	  <div class="col-sm-6">
		<h1 class="m-0 text-dark"><?php echo lang('edit_subcategory');?></h1>
	</div><!-- /.col -->
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  <li class="breadcrumb-item"><a href="<?php echo base_url()?>admin"><?php echo lang('home');?></a></li>
		  <li class="breadcrumb-item"><a href="<?php echo base_url()?>subcategory"><?php echo lang('subcategory');?></a></li>
		  <li class="breadcrumb-item active"><?php echo lang('edit_subcategory');?></li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary card-outline">
          <div class="card-body">
            	<?php
					...
					{
			   ?>
               <form class="form-horizontal" action="<?php echo base_url()?>subcategory/updates" method="post" enctype="multipart/form-data" id="subcategoryFormEdit">
                <div class="card-body">
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-10">
						<?php if($d["image"]!=""){?>
						<img src="<?php echo base_url();?>assets/files/subcategory/<?php echo $thumb_file;?>" width="250px" height="150px">
						<br/><br/>
						<?php }?>
                ...
                <div class="card-footer">
				  <input type="hidden" class="form-control" id="idsubcategory" name="idsubcategory" value="<?php echo $d["idsubcategory"];?>">
