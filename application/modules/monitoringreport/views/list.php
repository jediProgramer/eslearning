...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo lang('monitoring_report');?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>admin"><?php echo lang('home');?></a></li>
              <li class="breadcrumb-item active"><?php echo lang('monitoring_report');?></li>
            </ol>
          </div>
        </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <th><?php echo lang('feedback_coment');?></th>
				...
				<?php
					...
					$querysyllabus = $this->db->query("SELECT * FROM `".$this->db->dbprefix('syllabus')."` WHERE idcourses='".$do["idcourses"]."'");
					$rowsyllabus = $querysyllabus->row();
					$syllabus=$rowsyllabus->syllabus;
				...
				?>	
				 <tr>
				  ...
				  <td>
					<?php if($do["readreport"]!="1"){ ?><a class="btn btn-success btn-sm" href="#" data-toggle="modal" data-target="#modal-default-<?php echo $i;?>"><i class="fas fa-check-circle"></i></a><?php } ?>
				  </td>
                </tr>
						...
						<div class="modal-dialog">
						  <div class="modal-content">
							<div class="modal-header">
							  <h4 class="modal-title"><?php echo lang('monitoring_report');?></h4>
							...
							<form action="<?php echo base_url()?>monitoringreport/finish" method="post" enctype="multipart/form-data">
							  <input type="hidden" id="idreportmaterialcourses" name="idreportmaterialcourses" value="<?php echo $do["idreportmaterialcourses"];?>">
							</div>
